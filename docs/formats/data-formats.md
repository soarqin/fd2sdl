...
| `FDOTHER.DAT[77]` | 4 项标题 unsigned 8-bit mono PCM bank；SFX 0=标题飞行、1=确认、2=选择移动、3=标题 action 入场；SFX 0/1/2 使用 primary AIL handle，SFX 3 使用 secondary handle |
...
| [77] | 标题数字音效 bank | 4 | `title_action_menu @code0 0xf8d6..0xf8e6` 加载该 entry；SFX 0/1/2 分别用于飞行、确认、选择移动，SFX 3 通过 secondary handle 用于 action 入场 |
