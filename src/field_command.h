 ...
 *
 * 逆向依据：field_command_menu_open @0x3c630、
 * field_command_menu_input @0x3ca10、field_command_menu_close @0x3c8c8
...
#define FD2_FIELD_COMMAND_FRAME_COUNT 12u
 ...
 * attack/magic/item/wait × normal/highlight/disabled 排列。每帧为
 * u16 width + u16 height + 24×20 未压缩索引色像素。 */
